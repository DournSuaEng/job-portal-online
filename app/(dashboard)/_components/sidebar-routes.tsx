...
import { usePathname, useRouter } from "next/navigation"; // Corrected imports
...
const adminRoutes = [
  {
    icon: List,
    label: "Job",
    href: "/admin/jobs", // Added leading '/'
  },
  {
    icon: List,
    label: "Companies",
    href: "/admin/companies", // Added leading '/'
  },
  {
    icon: Compass,
    label: "Analytics",
    href: "/admin/analytics", // Added leading '/'
  },
];
...
const SidebarRoutes = () => {
  ...
  const handleShiftTimingChange =( shiftTiming :any[])=>{
