...
const CompanyDetailContentPage =({userId,company,jobs}: CompanyDetailContentPageProps)=> {
    ...
    return <div className="w-full rounded-2xl bg-white p-4 h-52 z-50  -mt-8">
        <div className="flex-col w-full px-4">
            ...
            <div className="w-full flex items-center justify-between -mt-12 ">
                <div className="flex items-end justify-end space-x-4">
                    ...
                    <div className=" flex-col space-y-1 ">
                        <div className="flex items-center gap-2">
                            <h2 className="text-xl font-sans font-bold text-neutral-700 capitalize">{company?.name}
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                           ...
                           <p className="border px-2 py-1 text-sm text-muted-foreground whitespace-nowrap rounded-lg">IT Servies & Consulting</p>
                ...
                <Button onClick={onClickAddRemoveFollower} className={cn ("w-24 rounded-full hover:shadow-md flex items-center justify-center border border-purple-500", !isFollower && "bg-purple-600 hover:bg-purple-700")}  variant={isFollower ? "outline": "default"}>
                    {isLoading ? <Loader2 className="w-3 h-3 animate-spin"/>: <React.Fragment>
