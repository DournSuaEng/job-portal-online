        ...
        <div className="mt-6 border bg-neutral-100 rounded-md p-4">
            ...
            {!isEditing && (!initialData.imageUrl ? (
                ...
                <div className="relative w-full h-60 aspect-video mt-2">
                    <Image alt="Cover Image" fill className="w-full h-full object-cover" src={initialData.imageUrl} />
                </div>
            ))}
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <ImageUpload
                                            ...
                                            onChange={(url: any) => field.onChange(url)}  // Corrected the arrow function syntax
