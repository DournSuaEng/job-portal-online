...
//import ShiftTimeingForm from "./_components/shift-timing-mode";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-x-2">
                        ...
                        <h2 className="text-xl text-neutral-600">Coustomize your job</h2>
                    </div>
                    {/* title form */}
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-xl text-neutral-700">Company Detial</h2>
                        </div>
